        ...
        const response = await openai.chat.completions.create({
            ...
            messages: [

                {
                    role: "system",
                    content:
                        "You are an expert programming language translator. Return only the translated code without markdown or explanations."
                },
        ...
        const response = await openai.chat.completions.create({
            ...
            messages: [

                {
                    role: "system",
                    content:
                        "You are an expert programming tutor. Explain code in simple language."
                },
        ...
        const response = await openai.chat.completions.create({
            ...
            messages: [

                {
                    role: "system",
                    content:
                        "You are an expert software engineer. Find coding errors, explain them, and provide corrected code."
                },
